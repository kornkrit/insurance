...
<?php 
     ...
     mysql_query("INSERT INTO `insurance`.`cars` (`id` ,`member_id` ,`mander` ,`type` ,`vehicle_registration` ,`country`) VALUES (NULL, '$last_member_id', '$mander', '$type', '$vehicle_registration', '$city')");
